...
const fileName = "penguin-translate-overlay.exe"

var ErrNotEmbedded = errors.New("desktop overlay binary is not embedded in this build")
...
func Materialize() (string, error) {
	...
	verPath := filepath.Join(dir, ".overlay_ver")
